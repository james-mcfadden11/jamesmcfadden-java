...
VALUES  ('user1', 'user1'),     -- user_id 1001
        ('user2', 'user2'),     -- user_id 1002
        ('user3', 'user3');     -- user_id 1003

INSERT INTO accounts
        (user_id, balance)
VALUES  (1001, 1000),           -- account_id 2001
        (1002, 1000);           -- account_id 2002

INSERT INTO transfers
        (transfer_type_id, transfer_status_id, account_from, account_to, amount)
VALUES
        (2, 2, 2001, 2002, 10); -- transfer_id 3001
