...
import com.techelevator.tenmo.model.transfer.TransferAuthorization;
...
public class TransferController {
    ...
    @RequestMapping(value = "/{transferId}/status", method = RequestMethod.PUT)
	public Transfer updateTransferStatus(@PathVariable Long transferId, @Valid @RequestBody TransferStatusUpdateDTO dto, Principal principal) {
    	...
    	performTransferUpdate(transfer, dto.getTransferStatus());
	...
	@Transactional
	private void performTransferUpdate(Transfer transfer, String newStatus) {
