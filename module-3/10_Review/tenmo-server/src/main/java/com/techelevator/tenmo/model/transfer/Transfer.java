...
public class Transfer {
	...
	private void validateUsers() {
    	if(userFrom == null) {
    		throw new IllegalArgumentException("null is not valid for userFrom");
		}

    	if(userTo == null) {
			throw new IllegalArgumentException("null is not valid for userTo");
		}
	}

	private void validateAmount() {
    	if(amount == null) {
    		throw new IllegalArgumentException("null is not valid for amount");
		}

    	if(amount.compareTo(BigDecimal.ZERO) <= 0) {
    		throw new IllegalArgumentException(amount + " is not valid for amount");
		}
	}
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(transferId, transfer.transferId) &&
				...
				transferStatus.equals(transfer.transferStatus) &&
