...
export default {
  ...
  methods: {
    ...
    deleteBoard() {
      ...
      /*
      prompt the user to ask if they are sure they want to delete

      if yes, delete

      - add delete board method to service
      - call the delete board method (pass in the board id)
      - if it worked, navigate back home
