...
export default {
  ...
  computed: {
    filteredReviews() {
      // return this.filterRating === 0 ? this.reviews : this.reviews.filter(r => r.rating === this.filterRating);
  ...
  methods: {
    ...
    saveNewReview() {
      this.newReview.rating = Number.parseInt(this.newReview.rating); // "2" -> 2
